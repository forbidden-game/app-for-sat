-- Fix request_english_grammar_analysis ambiguity (qualify column names)
--
-- CI failure symptom:
-- - SQLSTATE 42702: column reference "question_id" is ambiguous
--   (can refer to PL/pgSQL OUT parameter or a table column)
--
-- We ensure the final installed version of request_english_grammar_analysis always
-- qualifies columns with table aliases.
