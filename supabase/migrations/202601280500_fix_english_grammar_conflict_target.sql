-- Fix request_english_grammar_analysis conflict target to avoid PL/pgSQL ambiguity
--
-- Some environments can raise:
--   SQLSTATE 42702: column reference "question_id" is ambiguous
-- when a PL/pgSQL variable/out parameter shares a name with a column.
--
-- Using "ON CONFLICT ON CONSTRAINT ..." avoids referencing column names directly
