-- Bump English grammar analysis prompt version to v2

create or replace function public.request_english_grammar_analysis(
  p_question_id uuid,
  p_student_id uuid default null,
  p_prompt_version text default 'english-grammar-v2'
)
...
begin
  ...
  perform public.request_english_grammar_analysis(new.question_id, v_student_id, 'english-grammar-v2');
